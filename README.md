...
| Evan (2025-11-11 12:48:29 UTC+01:00 – present) | Reverted repository to the 266a466 baseline (keeping README/agent), added encoding/test safeguards, mocked Qt dialogs in tests, suppressed Stage-0 dialogs, and documented the automated CSV export behavior. |
